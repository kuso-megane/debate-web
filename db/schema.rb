...
ActiveRecord::Schema.define(version: 2019_10_02_081509) do
  ...
  create_table "opinions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["theme_id", "position", "opinion_type"], name: "index_opinions_on_theme_id_and_position_and_opinion_type"
